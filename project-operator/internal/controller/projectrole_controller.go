...
// +kubebuilder:rbac:groups=platform.example.io,resources=projectroles,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=platform.example.io,resources=projectroles/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=platform.example.io,resources=projectroles/finalizers,verbs=update
...
func (r *ProjectRoleReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&platformv1alpha1.ProjectRole{}).
		Named("projectrole").
		Complete(r)
}
